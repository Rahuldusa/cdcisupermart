...
const categories = [
  { name: "Blankets", icon: "🛏️" },
  { name: "Bedsheets", icon: "🛌" },
  { name: "Cushions", icon: "🛋️" },
  { name: "Sofa Covers", icon: "🛋️" },
  { name: "Door Mat", icon: "🚪" },
  { name: "Towel", icon: "🧼" },
  { name: "Pillow", icon: "🛏️" },
];
...
const AdditionalCollections: React.FC = () => {
  const [activeCategory, setActiveCategory] = useState("Blankets");
...
const fetchCollections = async (category: string) => {
  try {
    ...
    const url = `${baseURL}/api/get-by-type-category/Additional/${category}`;
      ...
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto leading-relaxed">
           Explore our premium home essentials — blankets, bedsheets, cushions, towels, and more crafted to bring warmth, elegance, and comfort to your living spaces.
          </p>
          <motion.div
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        ...
        >
          ...
          <h2 className="font-serif text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-slate-800 via-pink-600 to-slate-800 bg-clip-text text-transparent">
            Premium Home Comfort Collection
          </h2>
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
             Explore our curated range of home essentials — from soft blankets and elegant bedsheets to stylish cushions and décor items designed to bring warmth and comfort to your space.
      </p>
        </motion.div>
        ...
        >
          {categories.map((cat) => (
            ...
            >
              ...
              <Button
  onClick={() => setActiveCategory(cat.name)}
  onMouseEnter={() => {}}   // hover disabled
  onMouseLeave={() => {}}   // hover disabled
...
>
  ...
  {/* Removed hover overlay + gradient */}
...
export default AdditionalCollections;