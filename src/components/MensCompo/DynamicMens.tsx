...
const fetchCollections = async (category: string) => {
  try {
    ...
    const url = `${baseURL}/api/get-by-type-category/Men/${category}`;
  ...
  className="relative px-6 py-3 rounded-2xl border-2 border-[#850E35] bg-[#850E35] text-white font-semibold transition-none"
  variant="outline"
>
